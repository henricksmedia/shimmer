"""
release.py — the release check: is this file ready to upload?
...
from .dsp import as_2d, find_audible_bounds
from .mastering import measure_true_peak_db
...
def release_check(y: np.ndarray, sr: int, *,
    ...
    if tp is None and n:
        tp = _finite(measure_true_peak_db(y, sr))
